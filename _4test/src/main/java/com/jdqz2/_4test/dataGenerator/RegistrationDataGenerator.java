...
public class RegistrationDataGenerator extends RandomGenerator {
    ...
    private ArrayList<String> registrationCountryList = new ArrayList<>(Arrays.asList(
    ...
    public RegistrationFormData regGenerate(){
        ...
        data.country = getRandom(registrationCountryList);
